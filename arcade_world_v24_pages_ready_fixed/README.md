...
Pentru GitHub Pages ai două variante sigure:

1. **Recomandat:** Settings → Pages → Deploy from a branch → `main` / `/docs`
2. Alternativ, dacă publici din rădăcină, `index.html` din root redirecționează automat spre `docs/`

Buildul public pentru Pages este în `docs/` și oglindește conținutul din `static-app/`.
